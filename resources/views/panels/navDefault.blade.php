    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-expand-lg scrolling-navbar ">
        <div class="container">
            <a class="navbar-brand" href="{{url('/')}}">
                <img class="site-logo" src="{{ asset('images/logo.svg') }}" height="30" alt="siapm Logo">
                <p class="site-name ">Info Seputar Covid-19 <span> Kab. Lampung Barat</span></p>
            </a>
            ...
            <div class="collapse navbar-collapse" id="basicExampleNav">
                <ul class="navbar-nav ml-auto mr-3">
                    ...
                    <li class="nav-item dropdown {{Request::segment(1)=="laporan"?'active':''||Request::segment(1)=="dokumen"?'active':''}}">
                        <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown"
                            aria-haspopup="true" aria-expanded="false">Publikasi</a>
                        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="{{url('/laporan')}}">Laporan Donasi</a>
                ...
                <ul class="navbar-nav nav-flex-icons">
                    <li class="nav-item">
                        <a href="tel:08117222003" class="btn btn-danger btn-sm waves-effect rounded waves-effect mr-2" target="_blank">
                            <i class="fas fa-phone mr-1"></i> Laporan Warga
                        </a>
                    </li>
                </ul>

                ...
                <form role="form" method="POST" action="{{url('admin/kontak')}}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Atas Nama"
                                name="title" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Asal (<i>Kosongkan jika memilih kategori
                                    callcenter</i>)</label>
                            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Asal Kampus"
                                name="description">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nomor </label>
                            <input type="number" class="form-control" id="exampleInputEmail1"
                                placeholder="Contoh: 082180020273" name="nomor" required>
                        </div>
                    </div>
                    <!-- /.card-body -->
